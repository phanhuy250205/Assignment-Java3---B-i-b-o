...
<body>
	...
	<ul>
		<li class="current-menu-item" style="list-style-type: none;"><a
			href="index.html"> <img
				src="<c:url value='/assets/img/logologin.png' />" alt=""
	...
	<div class="main">
		...
		<c:if test="${empty cultureNew}">
			<p>Không có bài viết nào trong danh mục này.</p>
		</c:if>

		<!-- Lặp qua danh sách bài viết và hiển thị -->
		<c:forEach var="news" items="${cultureNew}">
